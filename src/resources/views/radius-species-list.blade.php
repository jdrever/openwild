<x-layout>
    ...
    function getUpdateUrl(pageNumber)
    {
        ...
        let updateUrl='/radius/longitude/{{ $longitude }}/latitude/{{ $latitude }}/'+speciesNameType+'/group/'+speciesGroup+'/axiophytes/'+axiophyteFilter+'/refresh?page='+pageNumber;
        return updateUrl;
    }
    </script>
...
<div class="d-flex align-items-center">
	...
	<h2>
		Species in Radius {{ $longitude . ' ' . $latitude }}
	</h2>
</div>
...
<div id="data-table">
    @include("data-tables/species-in-radius")
</div>
